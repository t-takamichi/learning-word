...
```
.agents/skills/impl-phase/references/agent/persona.md
```
...
```
.agents/skills/impl-phase/references/rules/phase-rules.md
```
...
```
.agents/skills/impl-phase/references/rules/quality-gate.md
```
