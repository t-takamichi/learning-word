...
```
.agents/skills/ux-design/references/agent/persona.md
```
...
全STEPで以下を守る。
```
.agents/skills/ux-design/references/rules/design-rules.md
.agents/skills/ux-design/references/rules/atomic-design.md
```

## 完了条件
STEP7後、品質ゲートで全項目パスを確認する。
```
.agents/skills/ux-design/references/rules/quality-gate.md
```
