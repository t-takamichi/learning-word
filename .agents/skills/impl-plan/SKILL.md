...
```
.agents/skills/impl-plan/references/agent/persona.md
```
...
```
.agents/skills/impl-plan/references/rules/plan-rules.md
```
...
```
.agents/skills/impl-plan/references/rules/quality-gate.md
```
